...
public class SpecialPackage extends BaseVo{
	private String addr;
	private String nm;
	private String extn;
	 ...
	 * @param extn
	 */
	public SpecialPackage(String title, String attrPath, String addr, String nm, String extn) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SpecialPackage other = (SpecialPackage) obj;
